...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Room', fields ['urlpath']
        db.delete_unique('room_room', ['urlpath'])


    def backwards(self, orm):
        # Adding unique constraint on 'Room', fields ['urlpath']
        db.create_unique('room_room', ['urlpath'])
